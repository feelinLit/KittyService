...
public class DefaultClient implements Client {
    ...
    public DefaultClient(String name, String surname, String address, String passport, int phoneNumber) {
        this.name = name;
    ...
    public final TrustworthinessRaiseEvent TrustworthinessRaiseEvent = new TrustworthinessRaiseEvent();
